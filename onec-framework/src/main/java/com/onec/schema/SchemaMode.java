...
/**
 * How the framework treats schema differences at startup ({@code onec.schema.mode}).
 *
 * <ul>
 *   <li>{@link #APPLY} (default) — execute safe changes; report destructive ones unless
 *       {@code onec.schema.allow-destructive=true}.</li>
    ...
    public static SchemaMode fromString(String value) {
        ...
        try {
            ...
            throw new IllegalArgumentException(
                    "Unknown onec.schema.mode '" + value + "'. Expected one of: apply, plan, validate, off.");
        }
    }
}
