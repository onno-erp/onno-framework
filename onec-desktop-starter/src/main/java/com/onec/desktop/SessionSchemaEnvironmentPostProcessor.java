...
public class SessionSchemaEnvironmentPostProcessor implements EnvironmentPostProcessor, Ordered {
    ...
    public void postProcessEnvironment(ConfigurableEnvironment environment, SpringApplication application) {
        ...
        if (url.startsWith("jdbc:postgresql:")) {
            schema = "classpath:onec-desktop/session/schema-postgresql.sql";
            ...
            schema = "classpath:onec-desktop/session/schema-h2.sql";
        } else {
            return;
        }
        ...
        environment.getPropertySources()
                .addLast(new MapPropertySource("onec-session-schema", defaults));
    }
