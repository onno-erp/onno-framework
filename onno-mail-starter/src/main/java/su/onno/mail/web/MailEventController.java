...
/**
 * Inbound delivery-event webhook (enabled via {@code onno.mail.webhook.enabled=true}). Accepts a list of
...
public class MailEventController {
    ...
    @PostMapping(path = "${onno.mail.webhook.path:/onno/mail/events}")
