 ...
 * {@link com.onec.rules.BusinessRule}s run on a best-effort transient entity built from the body.
 * Failures throw a field-mapped {@link com.onec.validation.ValidationException} (→ HTTP 422).
 */
