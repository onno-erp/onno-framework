...
/**
 * Bridges DivKit's {@code div-custom} block of type {@code onec-actions-menu} to the React
 ...
 * through the same {@code onec:action} host event the rest of the app uses. Mirrors the other
...
// Actions the cluster runs itself (with a loading state) rather than routing through onec:action:
...
/** Portals every live {@code <onec-actions-menu>} to its React cluster. Mount once, inside the Router. */
