...
| **UI** | a dashboard widget, page, action, or opt-in feature pack | `Page`/`Layout`/`EntityView`, custom widgets, or `EntityDetailUiContributor`/`ShellUiContributor` + `registerUiFeature` (see [onno-ui-starter/README.md](../onno-ui-starter/README.md)) |
