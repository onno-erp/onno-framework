 ...
 * backed by a <em>junction</em> — a catalog or an information register — rather than an owned
 ...
 * live from the junction (rows where {@code via} points at the current record). A <b>catalog</b>
 ...
 * @param junction    the junction class whose rows model the relationship — a {@code @Catalog} or
