...
/**
 * A resolved page widget. {@code rowBreak} forces this widget to start a new layout row
 * even when the previous row still has room (see {@code UiLayoutBuilder.WidgetBuilder#rowBreak()}).
 */
public record PageWidgetDescriptor(
        String title,
        String widgetType,
        int order,
        String width,
    ...
    public PageWidgetDescriptor(String title, String widgetType, int order, String width,
