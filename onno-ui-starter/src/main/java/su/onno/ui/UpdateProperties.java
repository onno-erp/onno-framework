...
/**
 * Configures the "update available" check: the running app periodically asks onno-cloud what the
 ...
 */
@ConfigurationProperties(prefix = "onno.ui.update-check")
public class UpdateProperties {

    /** Master switch. When false no outbound call is ever made and the notice never appears. */
    private boolean enabled = true;

    /** The onno-cloud endpoint that announces the latest release (see onno-cloud's ReleaseController). */
