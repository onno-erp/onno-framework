...
const DISMISSED_KEY = "onno.update.dismissed";
const TOAST_ID = "onno-update";
...
/**
 * Renders nothing; on mount it asks the server (which polls onno-cloud) whether a newer framework
  ...
  useEffect(() => {
    ...
    api
      ...
      .then((config) => {
        ...
        toast(`onno ${update.latest} is available.`, {
          id: TOAST_ID,
