...
import su.onno.ui.BrandPalette;
import su.onno.ui.BrandingConfig;
...
class BrandingPaletteTest {
    ...
    void sidebarLogo_rendersImageInsteadOfTextBrand() {
        ...
        // The mark is a home affordance — tapping it routes to "/" (an empty onno:// path).
        assertThat(((Map<String, Object>) header.get("action")).get("url")).isEqualTo("onno://");
    }
