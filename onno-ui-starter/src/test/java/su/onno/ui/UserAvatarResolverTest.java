...
/**
 * {@link UserAvatarResolver} resolves an author's avatar URL from the identity catalog's
...
class UserAvatarResolverTest {
    ...
    private UserAvatarResolver resolver(UiLayout layout, EntityView... views) {
        return new UserAvatarResolver(layout, registry, new FieldHintResolver(List.of(views)), jdbi);
    }
    ...
    void resolvesAvatarForAuthorsThatHaveOne() {
        UserAvatarResolver avatars = resolver(linkedLayout(), new EmployeeView());
    ...
    void noAvatarWhenIdentityCatalogHasNoAvatarHintedField() {
        ...
        UserAvatarResolver avatars = resolver(linkedLayout());
    ...
    void noAvatarWhenThereIsNoIdentityLink() {
        UserAvatarResolver avatars = resolver(new UiLayout(List.of()), new EmployeeView());
