 ...
 */
public class OnnoAfterConvertCallback implements AfterConvertCallback<Object> {

    private final MetadataRegistry registry;
    private final SecretCipher secretCipher;

    public OnnoAfterConvertCallback(MetadataRegistry registry, SecretCipher secretCipher) {
