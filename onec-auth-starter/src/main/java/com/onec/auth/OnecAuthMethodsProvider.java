...
/**
 * Derives the available {@link AuthMethods} from the active {@link OnecAuthProperties.Mode} and the
 ...
 */
class OnecAuthMethodsProvider implements AuthMethodsProvider {

    private final OnecAuthProperties properties;
    private final ObjectProvider<ClientRegistrationRepository> clientRegistrations;

    OnecAuthMethodsProvider(OnecAuthProperties properties,
     ...
     */
    private List<SsoProvider> ssoProviders(OnecAuthProperties.ResolvedOidc oidc) {
