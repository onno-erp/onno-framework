...
public class OnecNamingStrategy implements NamingStrategy {
     ...
     * exact table the {@link com.onec.schema.SchemaGenerator} created. A row class participates in a
    ...
    public OnecNamingStrategy(Map<Class<?>, String> tabularSectionTables) {
